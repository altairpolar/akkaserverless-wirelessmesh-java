...
// See: https://github.com/CryptoFacilities/REST-v3-Java/blob/master/Java/cfRestAPIv3/src/com/cryptofacilities/REST/v3/CfApiMethods.java
@SuppressWarnings("unused")
public class KrakenAccountCalls {
    ...
    public KrakenAccountCalls(String apiPath, String apiPublicKey, String apiPrivateKey, int timeout,
    ...
    public KrakenAccountCalls(String apiPath, boolean checkCertificate) {
    ...
    private String makeRequest(@SuppressWarnings("SameParameterValue") String requestMethod, String endpoint) throws IOException,
    ...
    public String getAccountBalance() throws KeyManagementException, InvalidKeyException,
    ...
    // Returns key account information
    public String getAccounts() throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
    ...
    public String getOrderBook(String symbol) throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
    ...
    // Returns key account information
    public String getAccount() throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
    ...
    public String sendOrder(String orderType, String symbol, String side, BigDecimal size, BigDecimal limitPrice,
                            BigDecimal stopPrice) throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
        ...
        if (orderType.equals("lmt")) {
            ...
            postBody = String.format("orderType=stp&symbol=%1$s&side=%2$s&size=%3$f&limitPrice=%4$f&stopPrice=%5$f", symbol,
    ...
    // Cancels an order
    public String cancelOrder(String orderId) throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
    ...
    public String getOpenOrders() throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
    ...
    public String getFills(Date lastFillTime) throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
    ...
    // Returns filled orders
    public String getFills() throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
        String endpoint = "/api/v3/fills";
        return makeRequest("GET", endpoint, "", "");
    }
    ...
    public String getOpenPositions() throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
    ...
    public String getRecentOrders(String symbol) throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
    ...
    // Returns xbt transfers
    public String getTransfers() throws KeyManagementException, InvalidKeyException,
            NoSuchAlgorithmException, IOException {
        String endpoint = "/api/v3/transfers";
        return makeRequest("GET", endpoint);
    }
