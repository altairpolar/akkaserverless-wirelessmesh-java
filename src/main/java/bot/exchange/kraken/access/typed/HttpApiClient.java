...
import bot.exchange.kraken.access.typed.result.ResultWithLastId;
...
public class HttpApiClient<T extends Result> {
     ...
     * @return result
     * @throws KrakenApiException Thrown if problem detected when sending, processing on server or responding the call.
     */
     ...
     *
     * @param response last response obtained
     * @return extracted result
     * @throws KrakenApiException Thrown if problem detected when extracing last id.
     */
