...
public class KrakenAPIClientTest {
    ...
    @Test
    public void should_return_ohlc() throws KrakenApiException {
    ...
    @Test
    public void should_return_ohlc_since_id() throws KrakenApiException {
    ...
    @Test
    public void should_return_recent_trades() throws KrakenApiException {
    ...
    @Test
    public void should_return_recent_trades_since_id() throws KrakenApiException {
    ...
    @Test
    public void should_return_recent_spread() throws KrakenApiException {
        // Given
    ...
    @Test
    public void should_return_recent_spread_since_id() throws KrakenApiException {
        // Given
        RecentSpreadResult mockResult = MockInitHelper.buildRecentSpreadResult();
    ...
    public void should_return_orders_information() throws IOException, KrakenApiException {
        ...
        KrakenAPIClient client = new KrakenAPIClient("apiKey", "apiSecret", mockClientFactory);
        OrdersInformationResult result = client.getOrdersInformation(Collections.singletonList("OGRQC4-Q5C5N-2EYZDZ"));
    ...
    public void should_return_open_positions() throws IOException, KrakenApiException {
        ...
        KrakenAPIClient client = new KrakenAPIClient("apiKey", "apiSecret", mockClientFactory);
        OpenPositionsResult result = client.getOpenPositions(Collections.singletonList("TY3TFI-KXBN3-LEICZJ"));
